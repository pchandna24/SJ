...
export default class Weather extends Component {
 ...
 predictor = async () => {
     ...
     await axios.get("http://api.agromonitoring.com/agro/1.0/weather/forecast?polyid=5e1f4cef4fcefd5403f9101d&appid=1e747d20859e4583fe202c9a38b1d709")
...
console.log("hello")
  ...
  <Text style={{color:'#f9f9f9',fontSize:15}}>{this.state.today}{"    "}{this.state.weather}</Text>
  <Text style={{color:'#f9f9f9',fontSize:15}}>{this.state.tom}{"     "}{this.state.weather1}</Text>
  <Text style={{color:'#f9f9f9',fontSize:15}}>{this.state.tom1}{"   "}{this.state.weather2}</Text>
  <Text style={{color:'#f9f9f9',fontSize:15}}>{this.state.tom2}{"    "}{this.state.weather3}</Text>
  <Text style={{color:'#f9f9f9',fontSize:15}}>{this.state.tom3}{"    "}{this.state.weather4}</Text>
                </View>
